...
class ExamplesControllerTest < ActionController::TestCase
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post :create, example: { active: @example.active, age: @example.age, name: @example.name }
    end
  ...
  test "should update example" do
    patch :update, id: @example, example: { active: @example.active, age: @example.age, name: @example.name }
    assert_redirected_to example_path(assigns(:example))
  end
