##Build a thermostat class that takes in a reading and a target temperature
##If it is not the desired temperature, it should turn on or off the heater by 5 degrees

##Complete exercise for homework
...
class Thermostat
  ...
  def self.detect_temperature(all_temps, target_temp)
    all_temps.each do |reading|
      ...
      puts "This is an instance of Thermostat with reading: #{r.temperature}." #printing attribute temperature on each instance of thermostat
