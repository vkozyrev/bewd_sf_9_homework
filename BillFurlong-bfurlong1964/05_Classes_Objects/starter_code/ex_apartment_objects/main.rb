...
#Getting info from users. Creating instance of building:
def create_building
  puts "-----------New Building-----------"
  ...
  puts "What is the number of apartments?"
  building_apartments = gets.strip
...
apt_count = gets.to_i
 ...
 0.upto(apt_count - 1) do |unit|
  ...
  #if apartment rented will ask for renter info
