...
class Main
  ...
  def call_name # from this, I should get all of the arguments that I need for Game class
    "#{name}"
    # Game.new(name, arguments that I called above)
  end
...
get_name = gets.strip
user = Main.new(get_name)
user.call_name

# put code here to create a new game, and start it
puts "Thanks #{user.call_name}. Let's start the game now!"
user.create_game
